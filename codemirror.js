...
<slot></slot>
  ...
  <body style="background-color: rgb(255, 255, 255);">
    <iframe id="backgroundImage" src="./codemirror_files/saved_resource.html"></iframe>
...
<!--_html_template_end_--></template> <!-- presubmit: ignore-long-line -->
  ...
  <ntp-logo id="logo" show-tight-doodle-boxing_=""><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$206056725$-->
  <div id="logo"></div>
...
<div id="inputWrapper">
  <!--?lit$206056725$-->
    ...
    <!--?lit$206056725$-->
      <div id="dragDropPlaceholder"><!--?lit$206056725$-->Drop files here</div>
...
<dialog id="dialog" part="dialog" role="application" aria-roledescription="Menu">
 ...
 <g>
    ...
    <!--?lit$206056725$-->
        <!--?lit$206056725$-->
        <h4 id="toolHeader"><!--?lit$206056725$-->Tools</h4><!--?-->
 ...
 <g viewBox="0 0 24 24">
        ...
        <span><!--?lit$206056725$-->Create images</span>
        <!--?lit$206056725$-->
      </button><!---->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$206056725$-->Add shortcut</span>
    </div>
  </cr-button>
  <div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$206056725$-->Show more</span>
      </div>
    </cr-button>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$206056725$-->Show less</span>
      </div>
    </cr-button>
  </div>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$206056725$--></div>
...
<div id="error" aria-live="assertive"><!--?lit$206056725$--></div></template>
      </cr-input>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <!--?lit$206056725$-->Restore default shortcuts
  </cr-button>
</cr-toast-manager>
<!--_html_template_end_--></template>
      </cr-most-visited>
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$206056725$-->
      <cr-toast id="undoToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
        <div id="undoToastMessage"><!--?lit$206056725$--></div>
