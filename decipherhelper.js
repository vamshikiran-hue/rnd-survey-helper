  ...
  <svg>
    <defs>
      ...
      <g id="stop" viewBox="0 0 12 12">
        <path d="M0 12V0H12V12H0Z" fill="currentColor"></path>
      </g>
      <g id="shareTabs" viewBox="0 -960 960 960">
        <path d="M160-240h640v-320H520v-160H160v480Zm0 80q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm0-80v-480 480Z" fill="currentColor"></path>
      </g>
  </defs>
  </svg>
...
<slot></slot>
  ...
  <svg>
    <defs>
      ...
      <g id="invertedQuoteFilled" viewBox="0 -960 960 960">
        <path d="M698-660l-58 100q66 0 113 47t47 113q0 66-47 113t-113 47q-66 0-113-47t-47-113q0-23 5.5-42.5T502-480l127-220q5-9 14-14.5t20-5.5q23 0 34.5 20t.5 40ZM338-660l-58 100q66 0 113 47t47 113q0 66-47 113t-113 47q-66 0-113-47t-47-113q0-23 5.5-42.5T142-480l127-220q5-9 14-14.5t20-5.5q23 0 34.5 20t.5 40Z" fill="currentColor"></path>
      </g>
      ...
      <g id="followUp" viewBox="0 0 24 24">
        <path d="M5 5V9C5 9.83334 5.29166 10.5417 5.875 11.125C6.45833 11.7083 7.16666 12 8 12H17.175L13.575 8.4L15 7L21 13L15 19L13.575 17.6L17.175 14H8C6.61667 14 5.4375 13.5125 4.4625 12.5375C3.4875 11.5625 3 10.3833 3 9V5H5Z" fill="currentColor"></path>
      </g>
...
<slot></slot>
  ...
  <svg>
    <defs>
      ...
      <g id="chat_spark" width="20" height="20" viewBox="0 0 20 20">
        <path d="M10 18a7.7 7.7 0 0 0-.625-3.104 7.858 7.858 0 0 0-1.73-2.542 7.86 7.86 0 0 0-2.54-1.729A7.7 7.7 0 0 0 2 10a7.7 7.7 0 0 0 3.104-.625 8.027 8.027 0 0 0 4.271-4.27A7.797 7.797 0 0 0 10 2a7.79 7.79 0 0 0 .625 3.104 8.28 8.28 0 0 0 1.708 2.563 8.28 8.28 0 0 0 2.563 1.708A7.797 7.797 0 0 0 18 10a7.797 7.797 0 0 0-3.104.625 8.027 8.027 0 0 0-4.27 4.27A7.7 7.7 0 0 0 9.999 18Z">
        </path>
      </g>
    </defs>
  </svg>
...
<!--_html_template_end_--></template> <!-- presubmit: ignore-long-line -->
  ...
  <!-- TODO(crbug.com/40743294): Instead of ?hidden="${!this.logoEnabled_}" it would
       ...
       the msan builder. See crbug.com/40743659. -->
  <ntp-logo id="logo" show-tight-doodle-boxing_=""><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$499488032$-->
  <div id="logo"></div>
...
<!--_html_template_end_--></template>
  ...
  <div id="searchboxContainer">
    <ntp-searchbox id="searchbox" placeholder-text="Ask Google" can-show-secondary-side="" compose-button-enabled="" composebox-enabled="" searchbox-layout-mode="Compact" ntp-realbox-next-enabled="" context-menu-glif-animation-state="ineligible" multi-line-enabled="" animation-state="" searchbox-voice-search-enabled_="" searchbox-lens-search-enabled_="" use-webkit-search-icons_="" color-source-is-baseline="" shown=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="inputWrapper">
  <!--?lit$499488032$-->
      <search-animated-glow part="animated-glow" animation-state="" entrypoint-name="Realbox"><template shadowrootmode="open"><!----><!--_html_template_start_-->
    <!--?lit$499488032$-->
      <div id="dragDropPlaceholder"><!--?lit$499488032$-->Drop files here</div>
      <div class="gradient gradient-outer-glow"></div>
      <div class="double-gradient"></div>
      <div class="double-gradient-mask"></div>
      <div class="gradient"></div>
      <div class="background" part="composebox-background">
      </div>
  ...
  <cr-searchbox-input id="input" exportparts="searchbox-input" input-aria-live="polite" multi-line-enabled="" placeholder-text="Ask Google" searchbox-aria-description="" searchbox-icon="//resources/cr_components/searchbox/icons/search_cr23.svg" allow-file-paste=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$499488032$-->
      <textarea id="input" autocomplete="off" part="searchbox-input" spellcheck="false" role="combobox" aria-controls="matches" aria-live="polite" aria-expanded="false" aria-description="" placeholder="Ask Google"></textarea>
...
<!--_html_template_end_--></template>
    <!--?lit$499488032$-->
      <div class="contextualEntrypointContainer contextualEntrypointContainerCompact" slot="contextual-entrypoint">
        <!--?lit$499488032$-->
<cr-composebox-file-inputs><template shadowrootmode="open"><!----><!--_html_template_start_-->
<!--?lit$499488032$-->
  <div id="fileUploadWrapper">
    <slot></slot>
  </div>
  <input type="file" id="imageInput" multiple="" hidden="" accept="image/avif,image/bmp,image/jpeg,image/png,image/webp,image/heif,image/heic">
...
<!--_html_template_end_--></template>
  <div class="context-menu-container" id="contextMenuContainer">
    <cr-composebox-contextual-entrypoint-and-menu id="context" exportparts="context-menu-entrypoint-icon" class="upload-button" disable-auto-reposition="" enable-multi-tab-selection_=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
    <!--?lit$499488032$-->
      <cr-composebox-contextual-entrypoint-button id="entrypointButton" exportparts="context-menu-entrypoint-icon, entrypoint-button" glif-animation-state="ineligible"><template shadowrootmode="open"><!----><!--_html_template_start_-->
  <div id="" class="">
    <!--?lit$499488032$-->
      <cr-icon-button id="entrypoint" class="ai-mode-button" part="context-menu-entrypoint-icon entrypoint-button" iron-icon="cr:add" noink="" title="Enhance your search with tabs, files, or an AI tool" aria-label="Enhance your search with tabs, files, or an AI tool" role="button" tabindex="0" aria-disabled="false" data-native-id="NewTabPageUI::kRealboxContextualEntrypointElementId"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
<cr-icon part="icon"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" role="none" style="display: block; height: 100%; width: 100%; pointer-events: none;">
 <g>
        <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path>
...
<!--_html_template_end_--></template>
    ...
    <cr-composebox-contextual-action-menu id="menu" enable-multi-tab-selection_="" style="--menu-gap: 0px;"><template shadowrootmode="open"><!----><!--_html_template_start_-->
  <cr-action-menu id="menu" role-description="Menu"><template shadowrootmode="open"><!---->
<dialog id="dialog" part="dialog" role="application" aria-roledescription="Menu">
  <div id="wrapper" class="item-wrapper" role="menu" tabindex="-1">
    ...
    <!--?lit$499488032$-->
      <button id="imageUpload" class="dropdown-item" role="menuitem">
        <cr-icon icon="composebox:imageUpload"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" style="display: block; height: 100%; width: 100%; pointer-events: none;">
 <g>
        <path d="M5 21C4.45 21 3.975 20.8083 3.575 20.425C3.19167 20.025 3 19.55 3 19V5C3 4.45 3.19167 3.98333 3.575 3.6C3.975 3.2 4.45 3 5 3H13C13 3.28333 13 3.59167 13 3.925C13 4.25833 13 4.61667 13 5H5V19H19V11C19.3833 11 19.7417 11 20.075 11C20.4083 11 20.7167 11 21 11V19C21 19.55 20.8 20.025 20.4 20.425C20.0167 20.8083 19.55 21 19 21H5ZM6 17H18L14.25 12L11.25 16L9 13L6 17ZM17 9V7H15V5H17V3H19V5H21V7H19V9H17Z" fill="currentColor"></path>
      </g></svg><!----></template></cr-icon>
        <!--?lit$499488032$-->Add images
      </button>
    <!--?lit$499488032$-->
      <button id="fileUpload" class="dropdown-item" role="menuitem">
      <cr-icon icon="composebox:fileUpload"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" style="display: block; height: 100%; width: 100%; pointer-events: none;">
 <g>
        <path d="M18 15.75C18 17.4833 17.3917 18.9583 16.175 20.175C14.9583 21.3917 13.4833 22 11.75 22C10.0167 22 8.54167 21.3917 7.325 20.175C6.10833 18.9583 5.5 17.4833 5.5 15.75V6.5C5.5 5.25 5.93333 4.19167 6.8 3.325C7.68333 2.44167 8.75 2 10 2C11.25 2 12.3083 2.44167 13.175 3.325C14.0583 4.19167 14.5 5.25 14.5 6.5V15.25C14.5 16.0167 14.2333 16.6667 13.7 17.2C13.1667 17.7333 12.5167 18 11.75 18C10.9833 18 10.3333 17.7333 9.8 17.2C9.26667 16.6667 9 16.0167 9 15.25V6H11V15.25C11 15.4667 11.0667 15.65 11.2 15.8C11.35 15.9333 11.5333 16 11.75 16C11.9667 16 12.1417 15.9333 12.275 15.8C12.425 15.65 12.5 15.4667 12.5 15.25V6.5C12.4833 5.8 12.2333 5.20833 11.75 4.725C11.2833 4.24167 10.7 4 10 4C9.3 4 8.70833 4.24167 8.225 4.725C7.74167 5.20833 7.5 5.8 7.5 6.5V15.75C7.48333 16.9333 7.89167 17.9417 8.725 18.775C9.55833 19.5917 10.5667 20 11.75 20C12.9167 20 13.9083 19.5917 14.725 18.775C15.5417 17.9417 15.9667 16.9333 16 15.75V6H18V15.75Z" fill="currentColor"></path>
      </g></svg><!----></template></cr-icon>
      <!--?lit$499488032$-->Add files
    </button>
    <!--?lit$499488032$-->
    ...
    <!--?lit$499488032$-->
        <!--?lit$499488032$-->
        <h4 id="toolHeader"><!--?lit$499488032$-->Tools</h4><!--?-->

    <!--?lit$499488032$--><!---->
      <button class="dropdown-item" role="menuitemradio" data-mode="4" aria-checked="false" aria-label="Tools: Create images">
        <!--?lit$499488032$-->
          <cr-icon icon="composebox:nanoBanana"><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" viewBox="0 0 24 24" class="cr-iconset-svg-icon_" style="display: block; height: 100%; width: 100%; pointer-events: none;">
 <g viewBox="0 0 24 24">
        <path d="M2 22.4004H22V2.40039H2V22.4004Z" fill="url(#pattern0_1500_179774)"></path>
          <defs>
          <pattern id="pattern0_1500_179774" patternContentUnits="objectBoundingBox" width="1" height="1">
        ...
        <span><!--?lit$499488032$-->Create images</span>
        <!--?lit$499488032$-->
      </button><!---->
  ...
  <!--_html_template_end_--></template>
    ...
    <!--?lit$499488032$-->
      <cr-searchbox-compose-button id="composeButton" slot="compose-button" compose-icon_="//resources/cr_components/searchbox/icons/search_spark.svg" ntp-realbox-next-enabled_=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="glowAnimationWrapper" class="glow-container">
  ...
  <cr-button id="composeButton" class="compose-container" title="Ask AI Mode in Google Search" role="button" tabindex="0" aria-disabled="false" has-prefix-icon_=""><template shadowrootmode="open"><!---->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
  ...
  <!--?lit$499488032$-->
    <!--?lit$499488032$-->
      <cr-most-visited id="mostVisited" single-row="" reflow-on-overflow="" expandable-tiles-enabled="" max-tiles-in-collapsed-state="6" max-shortcuts-in-expanded-state="10" max-most-visited-tiles-in-expanded-state="8" max-enterprise-shortcuts="10" visible_="" custom-links-enabled_=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="container" style="--tile-background-color: rgba(237, 242, 250, 1.00); --column-count: 1; --row-count: 1;">
  <!--?lit$499488032$-->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$499488032$-->Add shortcut</span>
    </div>
  </cr-button>
  <div>
    <cr-button id="showMore" tabindex="0" noink="" hidden="" aria-label="Show more" title="Show more" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$499488032$-->Show more</span>
      </div>
    </cr-button>
    <cr-button id="showLess" tabindex="0" noink="" hidden="" aria-label="Show less" title="Show less" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
      ...
      <div class="tile-title">
        <span><!--?lit$499488032$-->Show less</span>
      </div>
    </cr-button>
  </div>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$499488032$--></div>
...
<div id="label" class="cr-form-field-label">
  <!--?lit$499488032$-->Name
</div>
  ...
  <div id="input-container">
    <div id="inner-input-container">
      ...
      <div id="inner-input-content">
        ...
        <input id="input" part="input" autocomplete="off" autofocus="" tabindex="0" type="text" maxlength="" minlength="" inputmode="" aria-labelledby="label" aria-label="Name" aria-invalid="false">
...
<div id="error" aria-live="assertive"><!--?lit$499488032$--></div></template>
      </cr-input>
...
<div id="row-container" part="row-container">
  <div id="input-container">
    <div id="inner-input-container">
      ...
      <div id="inner-input-content">
        <slot name="inline-prefix"></slot>
        <input id="input" part="input" autocomplete="off" tabindex="0" type="url" maxlength="" minlength="" inputmode="" aria-labelledby="label" aria-label="URL" aria-invalid="false">
        <slot name="inline-suffix"></slot>
      </div>
    </div>
    <div id="underline-base"></div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <!--?lit$499488032$-->Restore default shortcuts
  </cr-button>
</cr-toast-manager>
<!--_html_template_end_--></template>
      </cr-most-visited>
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$499488032$-->
      <cr-toast id="undoToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
        <div id="undoToastMessage"><!--?lit$499488032$--></div>
        <cr-button id="undoButton" aria-label="Press Ctrl+Z to undo" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<svg>
  <defs>
    ...
    <rect x="-8" y="-8" width="1296" height="80"></rect></clippath>
  </defs>
</svg>
